...
@asynccontextmanager
async def start_tunnel_over_remotepairing(remote_pairing: RemotePairingTunnelService,
...
@asynccontextmanager
async def start_tunnel_over_core_device(service_provider: CoreDeviceTunnelService, secrets: Optional[TextIO] = None,
                                        max_idle_timeout: float = RemotePairingQuicTunnel.MAX_IDLE_TIMEOUT,
                                        protocol: TunnelProtocol = TunnelProtocol.QUIC) \
        -> AsyncGenerator[TunnelResult, None]:
